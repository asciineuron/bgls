...
def test_samples_correct_bitstrings_for_ghz_circuit(nqubits: int):
    ...
    sim = bgls.Simulator(
        ...
        compute_probability=bgls.born.cirq_state_vector_bitstring_probability,
    )
...
def test_results_same_when_seeded():
    ...
    sim_params = (
        ...
        bgls.born.cirq_state_vector_bitstring_probability,
    )
...
def test_run_with_density_matrix_simulator():
    ...
    sim_density_matrix = bgls.Simulator(
        ...
        cirq.protocols.act_on,
        bgls.born.cirq_density_matrix_bitstring_probability,
        seed=1,
    )
